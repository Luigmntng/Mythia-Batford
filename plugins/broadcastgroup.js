...
const anu = {
  ...
  for (let id of groups) conn.copyNForward(id, content, 'conversation', {quoted: anu, thumbnail: fs.readFileSync('./logo.jpg'), contextInfo:{externalAdReply: {title: `© ${conn.user.name} BROADCAST` , body: '>///<',sourceUrl: 'https://chat.whatsapp.com/DdMbKYRxn5TCFrB9m10XnQ', thumbnail: fs.readFileSync('./logo.jpg')}}} ,true)
